...
import { transcribeAndDeliverFor } from "@/server/transcript-delivery";
  ...
  const transcribeResult =
    outRow?.id != null
      ? await transcribeAndDeliverFor({
          messageId: outRow.id,
          studentId: prompt.student_id,
          teacherId: teacher.id,
          studentChatId: student.tg_chat_id,
          audioTgMessageId: sentMessageId,
          fileId: newFileId,
          kind,
        })
      : null;
