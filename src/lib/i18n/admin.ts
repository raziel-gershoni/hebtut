...
const settings = {
  ...
  toggles: {
    ...
    transcripts: {
      ...
      on: "После каждого голосового или кружка тренера ученик получает текстовую расшифровку в Telegram.",
      off: "Расшифровка не отправляется. Можно включить, если ученикам нужен текст к аудио.",
    },
  },
};
...
const subscription = {
  ...
  resetTrialButton: "Сбросить на пробный период (3 дня)",
  ...
  resetConfirmBody:
    "Подписка вернётся на 3 дня пробного периода. Активный платный период обнулится — вернуть его можно только повторной активацией.",
  lapseConfirmTitle: "Закрыть подписку?",
  lapseConfirmBody:
    "Подписка закроется немедленно. На следующее голосовое ученик получит сообщение 'Доступ закрыт'.",
...
const audit = {
  ...
  actions: {
    ...
    "signup.student": "Регистрация ученика",
