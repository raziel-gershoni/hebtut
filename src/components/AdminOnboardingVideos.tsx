  ...
  return (
    <section className="mb-4 rounded-2xl bg-tg-bg-section p-4 space-y-3">
      ...
      <p className="text-xs text-tg-text-hint">
        ...
        Файл автоматически обрежется по центру в квадрат 640×640 и
        обрежется до 60 секунд. Кодирование в браузере занимает несколько
        минут (один раз на файл) ради максимального качества. Если слот
        пустой — бот шлёт текст-заглушку.
      </p>
